    ...
    <div className="fixed inset-0 bg-[#191c1d]/60 backdrop-blur-sm z-[200] flex items-center justify-center p-4 antialiased">
      <div className="w-full max-w-lg bg-[#f8f9fa] border-none rounded-[1.5rem] shadow-[0_8px_24px_rgba(33,37,41,0.08)] overflow-visible flex flex-col max-h-[85vh] relative animate-in fade-in zoom-in duration-200">
        ...
        <div className="px-8 pb-8 overflow-y-auto flex-grow space-y-8" style={{ WebkitOverflowScrolling: 'touch' }}>
          ...
          {/* Select Zone */}
          <section className="space-y-4">
            <h2 className="font-headline text-[24px] font-bold text-[#191c1d] uppercase block">CHỌN KHU VỰC</h2>
            <div className="relative">
              <select className="w-full h-20 bg-white border-b-2 border-[#e0e3e8] font-body text-[18px] font-medium text-[#191c1d] px-6 rounded-xl appearance-none shadow-sm hover:border-[#c1c6d6] focus:border-[#1a73e8] focus:ring-4 focus:ring-[#1a73e8]/10 outline-none cursor-pointer transition-all">
                <option>Sân 1 (Trung tâm)</option>
                <option>Sân 2 (Phía Bắc)</option>
                <option>Sân 3 (Công viên)</option>
              </select>
        ...
        <footer className="p-8 bg-[#f3f4f5] border-t border-[#c1c6d6]/20 flex flex-col gap-4 relative z-0 shrink-0">
          <button type="button" onClick={onClose} className="w-full h-16 bg-gradient-to-b from-[#1A73E8] to-[#005BBF] hover:brightness-110 text-white font-headline text-[20px] font-bold rounded-xl shadow-[0px_8px_24px_rgba(33,37,41,0.08)] active:scale-95 transition-all uppercase tracking-wide border-none outline-none">
            XÁC NHẬN
          </button>
